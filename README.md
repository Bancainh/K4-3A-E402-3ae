...
**Lớp:** 3A · **Phòng:** E402 · **Cụm:** C1 · **Track:** A1

| Họ và Tên | Mã Học Viên | Vai trò chính | Phần việc đảm nhiệm trong dự án |
|---|---|---|---|
| Nguyễn Bá Chính | 2A202602654 | Team Lead / Product | Canvas, spec, GitHub, integration, checkpoint, pitch |
| Huỳnh Tấn Trung | 2A202602742 | Research & Evaluation | Evidence, survey, willing users, golden set, validation |
| Trần Anh Vũ | 2A202602570 | Prototype Engineer | User flow, prototype, AI integration, demo |
